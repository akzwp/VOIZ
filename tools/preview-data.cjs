...
function calendar() {
  ...
  <td id="calendar_toolbar" width="10%" align="left" valign="top">
    <div id="calendar_buttonbox" style="margin: 0px 10px 6px 10px; text-align: center;"><button type="button" class="button" id="calendar_newevent" data-preview-event-dialog><i class="fa fa-plus"></i>&nbsp;ایجاد رویداد جدید</button></div>
  ...
  <div id="calendar_eventdialog" style="display: none;"><table width="99%" border="0" style="padding:10px;">
    <tr class="letra12" height="40px"><td align="left" width="90px"><b>نام: <span class="required">*</span></b></td><td align="left" colspan="2"><input type="text" name="event" id="event" value="" style="width:274px; margin: 6px;"></td></tr>
    <tr class="letra12" id="desc"><td align="left"><b>توضیحات: </b></td><td align="left" colspan="2"><textarea name="description" style="width: 274px; margin: 6px;"></textarea></td></tr>
    <tr class="letra12" height="40px"><td align="left" width="90px"><b>تاریخ شروع: <span class="required">*</span></b></td><td align="left" width="175px" colspan="2" nowrap="nowrap"><input type="text" name="date" value="2026-09-15 10:30" style="width:80px"></td></tr>
    <tr class="letra12"><td align="left" width="90px"><b>تاریخ خاتمه: <span class="required">*</span></b></td><td align="left" width="175px" colspan="2" nowrap="nowrap"><input type="text" name="to" value="2026-09-15 11:30" style="width:80px"></td></tr>
    <tr class="letra12" height="40px"><td align="left" width="90px"><b>رنگ: <span class="required">*</span></b></td><td align="left" width="175px" colspan="2" nowrap="nowrap"><span id="colorSelector" style="padding-top: 11px; display: inline;"><div style="background: rgb(227, 83, 50);"></div></span></td></tr>
    <tr id="rowReminderEvent"><td align="left" colspan="3"><div id="divReminder"><input id="CheckBoxRemi" type="checkbox" class="CheckBoxClass" /><label id="lblCheckBoxRemi" for="CheckBoxRemi" class="CheckBoxLabelClass">هشدار تماس تلفنی</label></div></td></tr>
    <tr class="letra12 remin" height="40px" id="check"><td align="left"><b>تماس به: <span class="required">*</span></b></td><td align="left" colspan="2"><input type="text" name="call_to" id="call_to" style="width:70px">&nbsp;&nbsp;<span id="add_phone"><a href="#">جستجو در دفترچه تلفن</a></span></td></tr>
    <tr class="letra12 remin subElemento" height="40px"><td align="left"><b>یادآوری: <span class="required">*</span></b></td><td align="left"><select name="ReminderTime"><option>۱۰ دقیقه قبل</option><option>۳۰ دقیقه قبل</option></select>&nbsp;&nbsp;</td></tr>
    <tr class="letra12 remin subElemento" height="40px"><td align="left" colspan="3"><b>تبدیل متن به گفتار: <span class="required">*</span>&nbsp;&nbsp;&nbsp;</b><b><span class="counter">140</span></b><a id="listenTTS" style="cursor: pointer;"><img src="modules/calendar/images/speaker.png" style="position: relative; right: 0px;" alt="شنیدن" title="برای شنیدن کلیک کنید"/></a><div><textarea name="tts" style="width: 365px; height: 36px;" maxlength="140"></textarea></div></td></tr>
    <tr id="rowNotificateEmail"><td align="left" colspan="3"><div id="divNotification"><input id="CheckBoxNoti" type="checkbox" class="CheckBoxClass" /><label id="lblCheckBoxNoti" for="CheckBoxNoti" class="CheckBoxLabelClass">اعلام هشدار</label></div></td></tr>
    <tr class="letra12 notif" id="notification_email"><td align="left" colspan="3"><div><b id="notification_email_label">ایمیل برای اخطار دادن: <span class="required">*</span></b></div><div class="ui-widget"><textarea id="tags" cols="48px" rows="2" style="margin:6px; color: #333333; width: 365px; height: 36px; "></textarea></div></td></tr>
  </table></div>`;
}
function report() {
