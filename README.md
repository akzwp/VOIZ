...
بازطراحی و سفارشی‌سازی رابط کاربری: **© AKZ** — https://akzwp.com و https://akzwp.ir. اعتبار ویپ ایران / VOIPIRAN و مجوز GPL پروژه حفظ شده است؛ اعتبار AKZ مربوط به مشارکت در رابط کاربری است.
...
- دارای بسته فارسی پیام های صوتی استریسک Asterisk که توسط ویپ ایران ارائه شده است. (بازطراحی رابط این نسخه: AKZ)
